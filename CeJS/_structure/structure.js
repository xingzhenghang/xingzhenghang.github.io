...
/**
 * @name	library run time 骨干档
 * @fileoverview
 * library run time 骨干架构档。<br />
 ...
 * 本档案包含了呼叫其他 library (函式库)需要用到的 function，以及常用 base functions。<br />
 * A JavaScript module framework that is simple to use.<br />
 * 本计划希望能建立一个能简单上手的 JavaScript 模组架构。
 * <br />
...
驼峰式大小写命名规则 CamelCase → embedded_underscore/Snake case
...
本 library 大量使用了 arguments.callee，但这与 ECMAScript design principles 不甚相符，需要避免。
...
in case of
	...
	<a href="http://blog.miniasp.com/post/2009/11/JavaScript-JSON-Hijacking.aspx" accessdate="2009/12/2 0:18">在 Web 2.0 时代必须重视 JavaScript/JSON Hijacking 攻击</a>,
	etc.
</code>*/
