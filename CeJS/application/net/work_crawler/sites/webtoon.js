 ...
 * 
 * @fileoverview 本档案包含了解析并处理、批量下载 WEBTOON 韩国漫画 的工具。
 * 
 * <code>
...
function module_code(library_namespace) {
	...
	var default_configuration = {
		...
		// 最小容许图案档案大小 (bytes)。
		// 对于有些图片只有一条细横杆的情况。
		// e.g., webtoon\167 吸血鬼也没关系\0003 [第2话] 健忘症\167-3-036.png
		MIN_LENGTH : 130,

		// 解析 作品名称 → 作品id get_work()
		search_URL : function(work_title) {
			// 预设方法(callback var API)
		...
		get_chapter_list : function(work_data, html) {
			...
			// 穿越时空愚到你	https://www.webtoons.com/zh-hant/drama/2019foolsday/list?title_no=1562
			<span class="subj">水下那一分钟 ft. 奇奇怪怪 <梦境与真实></span>
			</code>
			 */
		...
		parse_chapter_data : function(html, work_data, get_label, chapter_NO) {
			...
			while (matched = PATTERN_image.exec(html)) {
				...
				// 去掉?type=q70s的部分 画质较好 q70是手机版 q90是电脑版
				delete matched.search_params.type;
				// 去除?x-oss-process=image/quality,q_90 可会有更高的画质
