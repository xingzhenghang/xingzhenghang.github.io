 ...
 *       comics.
 * 
 * @fileoverview 本档案包含了解析并处理、批量下载中国大陆常见漫画管理系统: 晴天漫画CMS (晴天漫画系统 晴天漫画程序, 晴天新漫画系统)
 *               PC端网站 + 手机端网站(行动版 mobile version) 的工具。
 * 
 * <code>
		...
		parse_chapter_data : function(html, work_data, get_label, chapter_NO) {
			...
			chapter_data = {
				image_list : chapter_data.map(function(url) {
					// 2019/10/20: 采用 base64_decode() 取代 atob() 后，
