...
, function(t, e, n) {
    ...
    var o, i = e.SET_A = 0, a = e.SET_B = 1, u = e.SET_C = 2, f = (e.SHIFT = 98,
    e.START_A = 103), c = e.START_B = 104, s = e.START_C = 105;
    e.MODULO = 103,
    e.STOP = 106,
    e.FNC1 = 207,
    e.SET_BY_CODE = (o = {},
        ...
        a(e, [{
            ...
            value: function(t, n, r) {
                ...
                if (t[0] >= 200) {
                    i = t.shift() - 105;
                    var a = c.SWAP[i];
                    void 0 !== a ? o = e.next(t, n + 1, a) : (r !== c.SET_A && r !== c.SET_B || i !== c.SHIFT || (t[0] = r === c.SET_A ? t[0] > 95 ? t[0] - 96 : t[0] : t[0] < 32 ? t[0] + 96 : t[0]),
                    o = e.next(t, n + 1, r))
                } else
...
, function(t, e, n) {
    ...
    function a(t, e, n) {
        ...
        for (var r = 0; r < e.length; r++)
            e[r].options = (0,
            s.default)(n, e[r].options),
            (0,
            h.default)(e[r].options);
        (0,
        h.default)(n),
        new (0,
    ...
    j.prototype.init = function() {
        if (this._renderProperties) {
            ...
            for (var e in this._renderProperties) {
                ...
                var n = (0,
                s.default)(this._options, t.options);
      ...
      , l = function(t) {
        function e(t, n) {
            ...
            /^[\x00-\x7F\xC8-\xD3]+$/.test(t))
                var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, (0,
                s.default)(t), n));
            else
                var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
            return i(r)
    ...
    var l = function() {
      ...
      , h = function(t) {
        ...
        l(e, [{
            key: "encode",
            value: function() {
                for (var t = a("*"), e = 0; e < this.data.length; e++)
                    t += a(this.data[e]) + "0";
                return t += a("*"),
                {
                    data: t,
...
, function(t, e, n) {
    ...
    var a = n(4)
      ...
      , c = function(t) {
        function e(t, n) {
            return r(this, e),
            o(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t + (0,
            f.mod10)(t), n))
        }
        return i(e, t),
        e
...
, function(t, e, n) {
    ...
    function o(t) {
        ...
        for (var n in f.default)
            f.default.hasOwnProperty(n) && (t.hasAttribute("jsbarcode-" + n.toLowerCase()) && (e[n] = t.getAttribute("jsbarcode-" + n.toLowerCase())),
